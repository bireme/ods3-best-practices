...
use Proethos2\ModelBundle\Entity\BestPracticeType;
use Proethos2\ModelBundle\Entity\BestPracticeRole;
use Proethos2\ModelBundle\Entity\BestPracticeEntity;
use Proethos2\ModelBundle\Entity\Institution;
use Proethos2\ModelBundle\Entity\Intervention;
use Proethos2\ModelBundle\Entity\Country;
use Proethos2\ModelBundle\Entity\PopulationGroup;
use Proethos2\ModelBundle\Entity\Stakeholder;
use Proethos2\ModelBundle\Entity\SubRegion;
use Proethos2\ModelBundle\Entity\Target;
...
use Proethos2\ModelBundle\Entity\TechnicalAttribute;
use Proethos2\ModelBundle\Entity\EvaluationAttribute;
...
class CRUDController extends Controller
{
    ...
    /**
     * @Route("/admin/controlled-list/best-practice-type", name="crud_admin_controlled_list_best_practice_type_list")
     * @Template()
     */
    public function listControlledListBestPracticeTypeAction()
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
        ...
        $item_repository = $em->getRepository('Proethos2ModelBundle:BestPracticeType');
        $trans_repository = $em->getRepository('Gedmo\\Translatable\\Entity\\Translation');
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            $session->getFlashBag()->add('success', $translator->trans("Item created with success."));
            return $this->redirectToRoute('crud_admin_controlled_list_best_practice_type_list', array(), 301);
        }
    ...
    /**
     * @Route("/admin/controlled-list/best-practice-type/{item_id}", name="crud_admin_controlled_list_best_practice_type_update")
     * @Template()
     */
    public function updateControlledListBestPracticeTypeAction($item_id)
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
    ...
    /**
     * @Route("/admin/controlled-list/best-practice-entity", name="crud_admin_controlled_list_best_practice_entity_list")
     * @Template()
     */
    public function listControlledListBestPracticeEntityAction()
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
        ...
        $item_repository = $em->getRepository('Proethos2ModelBundle:BestPracticeEntity');
        $trans_repository = $em->getRepository('Gedmo\\Translatable\\Entity\\Translation');
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            $session->getFlashBag()->add('success', $translator->trans("Item created with success."));
            return $this->redirectToRoute('crud_admin_controlled_list_best_practice_entity_list', array(), 301);
        }
    ...
    /**
     * @Route("/admin/controlled-list/best-practice-entity/{item_id}", name="crud_admin_controlled_list_best_practice_entity_update")
     * @Template()
     */
    public function updateControlledListBestPracticeEntityAction($item_id)
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
    ...
    /**
     * @Route("/admin/controlled-list/institution", name="crud_admin_controlled_list_institution_list")
     * @Template()
     */
    public function listControlledListInstitutionAction()
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
        ...
        $item_repository = $em->getRepository('Proethos2ModelBundle:Institution');
        $trans_repository = $em->getRepository('Gedmo\\Translatable\\Entity\\Translation');
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            $session->getFlashBag()->add('success', $translator->trans("Item created with success."));
            return $this->redirectToRoute('crud_admin_controlled_list_institution_list', array(), 301);
        }
    ...
    /**
     * @Route("/admin/controlled-list/institution/{item_id}", name="crud_admin_controlled_list_institution_update")
     * @Template()
     */
    public function updateControlledListInstitutionAction($item_id)
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
    ...
    /**
     * @Route("/admin/controlled-list/stakeholder", name="crud_admin_controlled_list_stakeholder_list")
     * @Template()
     */
    public function listControlledListStakeholderAction()
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
        ...
        $item_repository = $em->getRepository('Proethos2ModelBundle:Stakeholder');
        $trans_repository = $em->getRepository('Gedmo\\Translatable\\Entity\\Translation');
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            $session->getFlashBag()->add('success', $translator->trans("Item created with success."));
            return $this->redirectToRoute('crud_admin_controlled_list_stakeholder_list', array(), 301);
        }
    ...
    /**
     * @Route("/admin/controlled-list/stakeholder/{item_id}", name="crud_admin_controlled_list_stakeholder_update")
     * @Template()
     */
    public function updateControlledListStakeholderAction($item_id)
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
    ...
    /**
     * @Route("/admin/controlled-list/technical-matter", name="crud_admin_controlled_list_technical_matter_list")
     * @Template()
     */
    public function listControlledListTechnicalMatterAction()
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
        ...
        $item_repository = $em->getRepository('Proethos2ModelBundle:TechnicalMatter');
        $trans_repository = $em->getRepository('Gedmo\\Translatable\\Entity\\Translation');
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            $session->getFlashBag()->add('success', $translator->trans("Item created with success."));
            return $this->redirectToRoute('crud_admin_controlled_list_technical_matter_list', array(), 301);
        }
    ...
    /**
     * @Route("/admin/controlled-list/technical-matter/{item_id}", name="crud_admin_controlled_list_technical_matter_update")
     * @Template()
     */
    public function updateControlledListTechnicalMatterAction($item_id)
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
    ...
    /**
     * @Route("/admin/controlled-list/intervention", name="crud_admin_controlled_list_intervention_list")
     * @Template()
     */
    public function listControlledListInterventionAction()
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
        ...
        $item_repository = $em->getRepository('Proethos2ModelBundle:Intervention');
        $trans_repository = $em->getRepository('Gedmo\\Translatable\\Entity\\Translation');
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            $session->getFlashBag()->add('success', $translator->trans("Item created with success."));
            return $this->redirectToRoute('crud_admin_controlled_list_intervention_list', array(), 301);
        }
    ...
    /**
     * @Route("/admin/controlled-list/intervention/{item_id}", name="crud_admin_controlled_list_intervention_update")
     * @Template()
     */
    public function updateControlledListInterventionAction($item_id)
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
    ...
    /**
     * @Route("/admin/controlled-list/subregion", name="crud_admin_controlled_list_subregion_list")
     * @Template()
     */
    public function listControlledListSubRegionAction()
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
        ...
        $item_repository = $em->getRepository('Proethos2ModelBundle:SubRegion');
        $trans_repository = $em->getRepository('Gedmo\\Translatable\\Entity\\Translation');
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            $session->getFlashBag()->add('success', $translator->trans("Item created with success."));
            return $this->redirectToRoute('crud_admin_controlled_list_subregion_list', array(), 301);
        }
    ...
    /**
     * @Route("/admin/controlled-list/subregion/{item_id}", name="crud_admin_controlled_list_subregion_update")
     * @Template()
     */
    public function updateControlledListSubRegionAction($item_id)
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
    ...
    /**
     * @Route("/admin/controlled-list/target", name="crud_admin_controlled_list_target_list")
     * @Template()
     */
    public function listControlledListTargetAction()
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
        ...
        $item_repository = $em->getRepository('Proethos2ModelBundle:Target');
        $trans_repository = $em->getRepository('Gedmo\\Translatable\\Entity\\Translation');
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            if ( $post_data['subtext'] ) {
                $item->setSubtext($post_data['subtext']);
            }
            
            foreach(array('pt_BR', 'es_ES', 'fr_FR') as $locale) {
                if(!empty($post_data["subtext-$locale"])) {
                    $trans_repository = $trans_repository->translate($item, 'subtext', $locale, $post_data["subtext-$locale"]);
                }
            }
            ...
            $session->getFlashBag()->add('success', $translator->trans("Item created with success."));
            return $this->redirectToRoute('crud_admin_controlled_list_target_list', array(), 301);
        }
    ...
    /**
     * @Route("/admin/controlled-list/target/{item_id}", name="crud_admin_controlled_list_target_update")
     * @Template()
     */
    public function updateControlledListTargetAction($item_id)
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
    ...
    /**
     * @Route("/admin/controlled-list/population-group", name="crud_admin_controlled_list_population_group_list")
     * @Template()
     */
    public function listControlledListPopulationGroupAction()
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            $session->getFlashBag()->add('success', $translator->trans("Item created with success."));
            return $this->redirectToRoute('crud_admin_controlled_list_population_group_list', array(), 301);
        }
    ...
    /**
     * @Route("/admin/controlled-list/population-group/{item_id}", name="crud_admin_controlled_list_population_group_update")
     * @Template()
     */
    public function updateControlledListPopulationGroupAction($item_id)
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
    ...
    /**
     * @Route("/admin/controlled-list/country", name="crud_admin_controlled_list_country_list")
     * @Template()
     */
    public function listControlledListCountryAction()
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
        ...
        $item_repository = $em->getRepository('Proethos2ModelBundle:Country');
        $trans_repository = $em->getRepository('Gedmo\\Translatable\\Entity\\Translation');
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            $code = $item_repository->findOneByCode($post_data['code']);
            if($code) {
                $session->getFlashBag()->add('error', $translator->trans("Country code already registered"));
                return $this->redirect($referer, 301);
            }
            ...
            $session->getFlashBag()->add('success', $translator->trans("Item created with success."));
            return $this->redirectToRoute('crud_admin_controlled_list_country_list', array(), 301);
        }
    ...
    /**
     * @Route("/admin/controlled-list/country/{item_id}", name="crud_admin_controlled_list_country_update")
     * @Template()
     */
    public function updateControlledListCountryAction($item_id)
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
	...
	$referer = $request->headers->get('referer');
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            if ( $post_data['code'] != $item->getCode() ) {
                $code = $item_repository->findOneByCode($post_data['code']);
                if($code) {
                    $session->getFlashBag()->add('error', $translator->trans("Country code already registered"));
                    return $this->redirect($referer, 301);
    ...
    /**
     * @Route("/admin/controlled-list/outcomes", name="crud_admin_controlled_list_outcomes_list")
     * @Template()
     */
    public function listControlledListOutcomesAction()
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
        ...
        $item_repository = $em->getRepository('Proethos2ModelBundle:Outcomes');
        $trans_repository = $em->getRepository('Gedmo\\Translatable\\Entity\\Translation');
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            $session->getFlashBag()->add('success', $translator->trans("Item created with success."));
            return $this->redirectToRoute('crud_admin_controlled_list_outcomes_list', array(), 301);
        }
    ...
    /**
     * @Route("/admin/controlled-list/outcomes/{item_id}", name="crud_admin_controlled_list_outcomes_update")
     * @Template()
     */
    public function updateControlledListOutcomesAction($item_id)
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
    ...
    /**
     * @Route("/admin/controlled-list/goals", name="crud_admin_controlled_list_goals_list")
     * @Template()
     */
    public function listControlledListGoalsAction()
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
        ...
        $item_repository = $em->getRepository('Proethos2ModelBundle:Goals');
        $trans_repository = $em->getRepository('Gedmo\\Translatable\\Entity\\Translation');
    ...
    /**
     * @Route("/admin/controlled-list/goals/{item_id}", name="crud_admin_controlled_list_goals_update")
     * @Template()
     */
    public function updateControlledListGoalsAction($item_id)
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
    ...
    /**
     * @Route("/admin/controlled-list/evaluation-attribute", name="crud_admin_controlled_list_evaluation_attribute_list")
     * @Template()
     */
    public function listControlledListEvaluationAttributeAction()
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
        ...
        $item_repository = $em->getRepository('Proethos2ModelBundle:EvaluationAttribute');
        $trans_repository = $em->getRepository('Gedmo\\Translatable\\Entity\\Translation');
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            $item->setDescription($post_data['description']);
            foreach(array('pt_BR', 'es_ES', 'fr_FR') as $locale) {
                if(!empty($post_data["description-$locale"])) {
                    $trans_repository = $trans_repository->translate($item, 'description', $locale, $post_data["description-$locale"]);
                }
            }

            $item->setAttributeHelpText($post_data['attribute-help-text']);
            foreach(array('pt_BR', 'es_ES', 'fr_FR') as $locale) {
                if(!empty($post_data["attribute-help-text-$locale"])) {
                    $trans_repository = $trans_repository->translate($item, 'attribute_help_text', $locale, $post_data["attribute-help-text-$locale"]);
                }
            }

            $item->setDescriptionHelpText($post_data['description-help-text']);
            foreach(array('pt_BR', 'es_ES', 'fr_FR') as $locale) {
                if(!empty($post_data["description-help-text-$locale"])) {
                    $trans_repository = $trans_repository->translate($item, 'description_help_text', $locale, $post_data["description-help-text-$locale"]);
                }
            }

            $item->setHelpTextScoring1($post_data['help-text-scoring1']);
            foreach(array('pt_BR', 'es_ES', 'fr_FR') as $locale) {
                if(!empty($post_data["help-text-scoring1-$locale"])) {
                    $trans_repository = $trans_repository->translate($item, 'help_text_scoring1', $locale, $post_data["help-text-scoring1-$locale"]);
                }
            }

            $item->setHelpTextScoring2($post_data['help-text-scoring2']);
            foreach(array('pt_BR', 'es_ES', 'fr_FR') as $locale) {
                if(!empty($post_data["help-text-scoring2-$locale"])) {
                    $trans_repository = $trans_repository->translate($item, 'help_text_scoring2', $locale, $post_data["help-text-scoring2-$locale"]);
                }
            }

            $item->setHelpTextScoring3($post_data['help-text-scoring3']);
            foreach(array('pt_BR', 'es_ES', 'fr_FR') as $locale) {
                if(!empty($post_data["help-text-scoring3-$locale"])) {
                    $trans_repository = $trans_repository->translate($item, 'help_text_scoring3', $locale, $post_data["help-text-scoring3-$locale"]);
                }
            }

            $item->setHelpTextScoring4($post_data['help-text-scoring4']);
            foreach(array('pt_BR', 'es_ES', 'fr_FR') as $locale) {
                if(!empty($post_data["help-text-scoring4-$locale"])) {
                    $trans_repository = $trans_repository->translate($item, 'help_text_scoring4', $locale, $post_data["help-text-scoring4-$locale"]);
                }
            }

            $item->setScoring1($post_data['scoring1']);
            $item->setScoring2($post_data['scoring2']);
            $item->setScoring3($post_data['scoring3']);
            $item->setScoring4($post_data['scoring4']);

            $em->persist($item);
            $em->flush();

            $session->getFlashBag()->add('success', $translator->trans("Item created with success."));
            return $this->redirectToRoute('crud_admin_controlled_list_evaluation_attribute_list', array(), 301);
        }
    ...
    /**
     * @Route("/admin/controlled-list/evaluation-attribute/{item_id}", name="crud_admin_controlled_list_evaluation_attribute_update")
     * @Template()
     */
    public function updateControlledListEvaluationAttributeAction($item_id)
    {
        $output = array();
        $request = $this->getRequest();
        $session = $request->getSession();
